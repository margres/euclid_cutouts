...
cutouts to be taken from DR1/R1 (instead of the default R2-first lookup), for
...
Run:
    python make_lens_mosaics_r1.py
"""
...
OUTPUT_DIR    = "/media/user/cutana_dr1_pipeline/results/lens_mosaics_r1"
R1_RELEASE_DIR = "/media/home/data/euclid_idr1/DR1/R1"
THUMB         = 150
GRID_COLS     = 5
...
def build_lens_sample_r1() -> pd.DataFrame:
...
def build_combined_mosaic(sample: pd.DataFrame) -> None:
    ...
    out_path = os.path.join(OUTPUT_DIR, "mosaic_combined_all_pipelines_r1.png")
    mosaic.save(out_path)
...
def main():
    ...
    sample = build_lens_sample_r1()
    sample.to_csv(os.path.join(OUTPUT_DIR, "lens_sample_r1.csv"), index=False)
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_cutana_png_asinh_r1.png"), "Cutana PNG (asinh) - R1")
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_azulero_jpg_r1.png"), "Azulero JPEG - R1")
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_bulk_euclid_mtf_r1.png"), "bulk-euclid MTF - R1")
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_bulk_euclid_arcsinh_vis_y_r1.png"), "bulk-euclid arcsinh VIS+Y - R1")
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_bulk_euclid_arcsinh_vis_only_r1.png"), "bulk-euclid arcsinh VIS-only - R1")
    ...
    build_mosaic(paths, labels, os.path.join(OUTPUT_DIR, "mosaic_eummy_png_r1.png"), "eummy PNG - R1")
